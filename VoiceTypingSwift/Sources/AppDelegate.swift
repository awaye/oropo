...
/// Main application delegate handling menu bar and hotkey
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func buildMenu() -> NSMenu {
        ...
        // Status item
        statusMenuItem = NSMenuItem(title: "Status: Loading...", action: nil, keyEquivalent: "")
        ...
        // Help
        let helpItem = NSMenuItem(title: "❓ How to Use", action: #selector(showHelp), keyEquivalent: "h")
    ...
    private func startRecording() {
        guard !isRecording && !isProcessing && transcriptionEngine.isModelLoaded else { return }
